import { AbstractGame, ctx, canvas, range } from "./init.js";
export class Enemy extends AbstractGame {
    constructor() {
        super(...arguments);
        this.coor = []; // coor enemy
    }
    draw() {
    ...
    hit(coor) {
        ...
        const hitX = game.coor.x + pSize >= coor.x &&
            coor.x + pSize >= game.coor.x;
        const yHit = game.coor.y >= coor.y &&
